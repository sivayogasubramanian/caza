...
export function ResponsiveNavBar({ children }: Props): JSX.Element {
  return (
    <div>
      <section className="invisible md:visible h-14 ">{topBar()}</section>
      <section className="fixed top-0 left-0 md:top-14">{children}</section>
...
const topBar = () => (
  <section className="block fixed top-0 inset-x-0 z-50 text-gray-400 bg-gray-300">
